...
function montarLayout() {
  ...
  // Páginas com sidebar própria (admin.html) não têm #topbar-slot nem
  // #bottomnav-slot no HTML — então isso já não faz nada nelas. O tema
  // de cor da competição, nessas páginas, é aplicado à parte por
  // admin-dashboard.js (aplicarTemaCompeticaoSemUi).
