  ...
  return `
    <div class="materia-byline">
      ...
      <div class="info">
        ...
        <p class="veiculo">${assinatura.tipo === "reporter" ? `${assinatura.arroba} · Repórter do ${assinatura.timeCobertura || ""}` : "Reportagem especial"}</p>
      </div>
    </div>
  `;
}
...
// banco, não inventados, igual ao que já aparece em jogador.html.
