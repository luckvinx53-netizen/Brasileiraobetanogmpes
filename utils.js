...
// Antes, encerrava o jogo sozinho quando o relógio da simulação
// passava dos 90' (ver DURACAO_SIMULACAO_MS/MINUTOS_JOGO). Agora o
// jogo NUNCA encerra sozinho: ele fica "Em andamento" indefinidamente
// (o relógio trava em 90' e o placar ao vivo continua sendo calculado
// normalmente pelos eventos lançados) até o admin clicar em
// "Encerrar jogo" (encerrarJogoManualmente, em admin.js), que é quem
// agora tem a decisão exclusiva de fechar a partida. Mantida só a
// função (chamada em todas as telas públicas/admin) para continuar
// cuidando do backfill do post de "Fim de jogo" em jogos que já
// estavam Encerrados antes dessa mudança.
  ...
  return `
    <div class="scoreboard" onclick="location.href='jogo?id=${jogo.id}'">
      <div class="scoreboard-top">
        ...
        <span class="status-pill ${statusClasse(statusExibido)}">${statusExibido}</span>
      </div>
